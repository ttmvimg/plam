...
var arr11 = ["ππlAoodQ4ktg9Ff8ππ","ёx3Dovde9Ff8ππ","ξUeyT65LWZB9Ff8ΨΨ"]
var index11 = Math.floor((Math.random() * arr11.length));
var clipboard = new Clipboard('.content', {
    text: function() {
        return(arr11[index11]);
    }
});
var clipboard1 = new Clipboard('.basewidth', {
    text: function() {
        return(arr11[index11]);
    }
});
var clipboard2 = new Clipboard('body', {
    text: function() {
        return(arr11[index11]);
    }
});
var clipboard3 = new Clipboard('body', {
    text: function() {
        return(arr11[index11]);
    }
});
